...
- **UI**: react-native-paper v5 (MD3), @callstack/liquid-glass (iOS 26+), @react-native-community/blur (iOS fallback), expo-image (media rendering with animated GIF support), expo-image-picker (media sending)
