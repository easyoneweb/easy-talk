...
- **Media** — Send and receive images, GIFs, and videos; inline previews with animated GIF support; fullscreen video player on all platforms; pick GIFs directly from the Android keyboard (Gboard etc.)
...
| Media | expo-image (display) + expo-image-picker (sending) + expo-video (playback) |
